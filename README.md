...
| `取得文書ekde20260401/` | 2026-04-01〜2026-08-13 (+Monato のみ 2026-03-04〜) | 311 | 6サイト (Pola Retradio 除外)。Monato はプローブで補完済み |
...
2026-08-13 時点で既知の Monato 欠落はすべて補完済み (`取得文書ekde20260303` の 2025-03〜2026-02 は ID 13550〜13872 のプローブで回収。詳細は同フォルダの MANIFEST.md)。なお 2024 年以前の publika 記事にも Nova! 非掲載の日付なしページが存在することがプローブで判明している (ID 13587, 13615, 13621, 13646, 13659 など) — 2024 年以前を再整備する場合は年別インデックスとプローブの併用が必要。
