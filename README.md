...
| フォルダ | 期間 | 記事数 | 備考 |
|---|---|---|---|
| `取得文書ekde20260303/` | 2025-03-03〜2026-03-03 | 1023 | 7サイト。**Monato の2025-03〜12が下記仕様により欠落** |
...
**未解消**: `取得文書ekde20260303` の Monato 2025-03〜2025-12 (推定 ID 13500台〜13830)。回収する場合は backfill_publika_probe.py で ID 帯を指定するのが確実。
