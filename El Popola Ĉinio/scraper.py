# -*- coding: utf-8 -*-
"""
CLI ツール：指定期間に公開された El Popola Ĉinio の記事 URL と本文を収集して書き出し
...
_session = elpopola_lib.shared_session
...
def parse_args():
    p = argparse.ArgumentParser(description="El Popola Ĉinio 期間指定スクレイパー")
